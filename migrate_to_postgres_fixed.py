...
def import_csv_to_postgres():
    ...
    table_order = [
        'users', 'corsi', 'corsi_archiviati', 'lezioni', 'archiviate', 'fatture', 'fatture_lezioni'
    ]
    ...
    for table_name in table_order:
        ...
        if csv_file not in csv_files:
            print(f"  Nessun file CSV trovato per la tabella {table_name}")
            continue
